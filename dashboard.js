document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("welcomeMessage").innerText = `Xin chào ${userID},Chúc bạn một ngày tốt lành!`; //   Hiển thị chào mừng
    ...
    try {
        ...
        if (result.students) {
            ...
            if (result.students.length > 0) {
                ...
                const headers = Object.keys(result.students[0]);
                ...
                result.students.forEach(student => {
                    ...
                    headers.forEach(header => {
                        ...
                        td.textContent = JSON.stringify(student[header], null, 2);
                        row.appendChild(td);
                    });
